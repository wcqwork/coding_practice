(function (window, $, undefined) {
   ...
   * deep clone 后插入移动端 .phone_show 里的 .nav-main-pc 容器。
   *
  ...
  function syncPcElementsToMobileNav(nodeObj) {
    ...
    var $targetNavMainPc = $mobileScope.find('.nav-main-pc');
    ...
    var $topLevel = $pcElements.filter(function () {
      return !$(this).parentsUntil($pcScope).filter(markerSelector).length;
    });
