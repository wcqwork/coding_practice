...
(function() {
  ...
  Object.assign(threeSourceImport, {
      init: async function(options) {
          const deeped = {
              cssDeep: [],
              jsDeep: [leadComponentSite.previewDomain + '/static/assets/blockEditor/script/three.js', leadComponentSite.previewDomain + '/static/assets/blockEditor/script/OBJLoader.js', leadComponentSite.previewDomain + '/static/assets/blockEditor/script/STLLoader.js', leadComponentSite.previewDomain + '/static/assets/blockEditor/script/OrbitControls.js', leadComponentSite.previewDomain + '/static/assets/blockEditor/script/tween.js', leadComponentSite.previewDomain + '/static/assets/blockEditor/script/screenfull.js', ]
          }
          await leadComponentSite.jsDeepSuccess(deeped.jsDeep, deeped.cssDeep)
          leadComponentSite.renderCallback(options)
      }
  ...
  Object.assign(slickSourceImport, {
      init: async function(options) {
          const deeped = {
              cssDeep: [leadComponentSite.previewDomain + '/static/assets/blockEditor/styles/slick.css?t=20241213', leadComponentSite.previewDomain + '/static/assets/blockEditor/styles/slick-theme.css?t=20250111'],
   ...
   * jQuery datepiker
   */
  var datepikerPlugin = leadComponentSite.datepiker || (leadComponentSite.datepiker = {});
  Object.assign(datepikerPlugin, {
      init: async function(options) {
          const deeped = {
              cssDeep: [leadComponentSite.previewDomain + '/static/assets/widget/script/plugins/air-datepicker/css/datepicker.css'],
              jsDeep: [leadComponentSite.previewDomain + '/static/assets/widget/script/plugins/air-datepicker/js/datepicker.js', leadComponentSite.previewDomain + '/static/assets/widget/script/plugins/air-datepicker/js/i18n/datepicker.en.js']
          }
          await leadComponentSite.jsDeepSuccess(deeped.jsDeep, deeped.cssDeep)
          leadComponentSite.renderCallback(options)
      }
  ...
  /**
   * mCustomScrollbar-concatleadComponentSite.searchTimer
   */
  ...
  Object.assign(motionHelperSourceImport, {
      init: async function(options) {
          const deeped = {
              cssDeep: [],
              jsDeep: [leadComponentSite.previewDomain + '/static/assets/blockEditor/script/motion_helper.js?t=2026011602']
          }
          await leadComponentSite.jsDeepSuccess(deeped.jsDeep, deeped.cssDeep)
          leadComponentSite.renderCallback(options)
      }
  ...
  /**
   * fixedHover.js 页头悬浮js
   */
  var fixedHoverSourceImport = leadComponentSite.fixedHoverSourceImport || (leadComponentSite.fixedHoverSourceImport = {});
  Object.assign(fixedHoverSourceImport, {
      init: async function(options) {
          const deeped = {
              cssDeep: [],
              jsDeep: [leadComponentSite.previewDomain + '/static/assets/blockEditor/script/fixedHover.js']
          }
          await leadComponentSite.jsDeepSuccess(deeped.jsDeep, deeped.cssDeep)
          leadComponentSite.renderCallback(options)
      }
...
(function() {
  onloadHack(function() {
      ...
      !phoenixSite.faptcha.init && $.extend(faptcha, {
          $: function(a) {
      ...
      !phoenixSite.faptcha2.reload && $.extend(faptcha2, {
      ...
      !phoenixSite.faptcha3.reload && $.extend(faptcha3, {
          $: function(a) {
              return 'string' == typeof a ? document.getElementById(a) : a;
          },
...
(function(window, $, undefined) {
  ...
  // 弹窗方法
  $.extend(form, {
      popup: async function(formType, formName, redirectUrl, pageId, pageType, editorPageId, trackingCodeId, formId, redirectPageId) {
          ...
          var _options = {
              ...
              success: async function(xhr) {
                  ...
                  try {
                      if ($(".pop-inquire .pop-main").find("input.timePicker").length) {
                          var leadComponentSite = window.leadComponentSite || (window.leadComponentSite = {});
                          await leadComponentSite.datepiker.init({})
                      }
                      // 时间选择器加载
                      $(".pop-inquire .pop-main").find("input.timePicker").each(function() {
                          var this_ = $(this);
                      ...
                      $(".pop-inquire .pop-main").find(".timePickers .timePicker").on("blur", function() {
                          if ($(this).index() == 0) {
...
(function(window, $, undefined) {
  ...
  window.resizeDebounce = function(func, offsetPx, delay=300) {
      ...
      // 暴露一个函数，供编辑器环境手动调用
      window._executeResizeFunc = function() {
          func('resize');
      }
      ;
      ...
      window._resizeHandler = function() {
          // 通过检查frameElement来判断是否在编辑器的iframe内
          const inEditor = window.editor_version || false

          if (inEditor) {
              // 在编辑器中，resize事件由编辑器在切换设备后手动触发，此处不执行
              return;
          }
